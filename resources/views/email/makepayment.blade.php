...
<head>
    ...
    <style type="text/css">
        ...
        .footer {
            ...
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url({{ $domain . '/public/assets/img/'.$theme->background }});
            background-size: cover;
                ...
                <tr>
                    <td style="text-align: center; padding: 10px 0px">
                        <a href="{{$theme->url}}"><img
                                src="{{ $domain . '/public/assets/img/'.$theme->logo }}" alt="" width="140" /></a>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 20px 0">
                        ...
                        <p>
                            We have received your nomination from <b>{{ $organization }}</b> under the category of
                            <b>"{{ $category }}"</b> successfully. Please make a payment of
                            <b>{{number_format($total)}}</b> Taka using the following link.
                        </p>
